@adminEnd2End @regression @adminDash @bb @dash @rohit
Feature: Dashboard
...
Then i should navigate to dash and verify that the order shows in admin dashboard "testing for order in admin dash"
