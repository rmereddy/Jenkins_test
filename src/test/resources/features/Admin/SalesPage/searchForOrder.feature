@adminEnd2End @regression  @searchOrder @salesPage
Feature: sales page
...
Then i should navigate to the sales page and be able to search for orders by "Jest"
And search orders by "Tahiru"
And search for orders by order number
