@adminEnd2End @regression @chargeClient @salesPage
Feature: sales page
...
Scenario: charge client from charge client panel
...
Then i should successfuly charge client from the charge client panel "Order has been paid!"
