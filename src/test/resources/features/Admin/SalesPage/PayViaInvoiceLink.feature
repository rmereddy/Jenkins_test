@adminEnd2End @regression @payViaInvoiceLink @salesPage
Feature: sales page
...
Scenario: pay order via invoice link
...
And i enter the name on card "Test Card"
And i enter a card number "4111111111111111"
And i enter cc exp date "1119"
And i enter cc cvv "227"
