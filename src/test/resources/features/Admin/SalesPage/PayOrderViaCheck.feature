@adminEnd2End @regression  @payOrderViaCheck @salesPage
Feature: sales page
...
And i select the "Check" as the payment source
And i click the pay via external method button
Then i should successfuly pay via external method button "paid!"
