@chefPageEnd2End @adminEnd2End @editMenuCard @regression @smoke
Feature: chef's page
in order for an admin to edit a menu card
...
When i enter chefs first name "editMenuCard"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@editMenuCard.com"
...
And i i enter chefs account name "testEditMenuCard"
...
And i change menu card name "edited menu card"
And i change menu card status
And i change menu card day part
And i change menu card cuisine type
And i change menu card marketplace featured ranking "5"
