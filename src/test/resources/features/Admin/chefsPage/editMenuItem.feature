@chefPageEnd2End @adminEnd2End @editMenuItem @regression
Feature: chef's page
...
When i enter chefs first name "editMenuItem"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@editmenuitem.com"
...
And i i enter chefs account name "testEditingMenuItem"
...
And i change the manu item name "edited menu item"
And i change the menu item ingredients "teriyaki sauce"
And i change the menu item description "this edited item is for testing purposes"
And i change the menu item servings per package "50"
And i select the menu item serving utensils "Ice Cream Scooper"
And i enter the menu item chefs price "22"
And i enter the menu item market price "22"
