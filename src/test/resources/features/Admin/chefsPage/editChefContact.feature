@chefPageEnd2End @adminEnd2End @editChefContact @regression
Feature: chef's page
in order for an admin to edit a chefs contact
the user with admin access will have to login and navigate to the chefs page
and navigate to a chefs contacts page where they will be able to edit the contact
...
Scenario: edit chef contact
Given i am on the chefs page
And i click on add new chef button
When i enter chefs first name "editChef Contact"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@editChefContact.com"
...
And i i enter chefs account name "testEditChefContact"
...
And i change chefs contact name "test name"
And i change chefs contact role "booking"
And i change chefs contact email "editedtestcontactemail@test.com"
And i enter new contact phone number "2020202000"
