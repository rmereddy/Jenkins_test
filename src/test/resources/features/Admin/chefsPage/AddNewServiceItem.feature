@chefPageEnd2End @adminEnd2End @addNewServiceItem @regression
Feature: chef's page
in order for an admin to add a new service item
the user with admin access will have to login and navigate to the chefs page
and navigate to a service items tab where they will be able to add the service item
...
When i enter chefs first name "AddServiceItem"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@AddServiceItem.com"
...
And i enter description "testing service items"
