@chefPageEnd2End @adminEnd2End @deleteChefContact @regression
Feature: chef's page
in order for an admin to delete the contact for a chef
the user with admin access will have to login and navigate to the chefs page
and navigate to a chefs contacts page where they will be able to delete the contact
...
Scenario: delete chef contact
Given i am on the chefs page
And i click on add new chef button
When i enter chefs first name "deleteContact"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@deleteContact.com"
...
And i i enter chefs account name "testDeleteContact"
