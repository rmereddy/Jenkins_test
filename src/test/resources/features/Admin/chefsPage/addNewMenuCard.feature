@chefPageEnd2End @adminEnd2End @addNewMenuCard @regression 
Feature: chef's page
...
When i enter chefs first name "addMenuCard"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@addMenuCard.com"
...
And i i enter chefs account name "testAddMenuCard"
