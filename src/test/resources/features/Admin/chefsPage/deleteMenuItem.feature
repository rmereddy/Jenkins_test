@chefPageEnd2End @adminEnd2End @deleteMenuItem @regression
Feature: chef's page
in order for an admin to delete a menu itemfor a chef
the user with admin access will have to login and navigate to the chefs page
and navigate to a chefs menu items page where they will be able to delete the menu item
...
When i enter chefs first name "deleteMenuItem"
And i enter chefs last name "testing"
And i enter chefs email "testEmail@deleteMenuItem.com"
...
And i i enter chefs account name "testDeleteMenuItem"
