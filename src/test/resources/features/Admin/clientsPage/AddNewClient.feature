@clientsPageEnd2End @adminEnd2End @addNewClient @regression 
Feature: clients page
in order for an admin to be able to add a new client
the user with admin access will have to login and navigate to the clients page
where they will be able to add the new client
...
@addNetAndTaxExemptClient
Scenario: Add a new net and tax exempt client
Given i am on the clients page
And i click on add new client button
When i enter clients account name "NewClient TestingTesting"
And i enter the number of employees "30"
...
@addPayByCheckClient
Scenario: Add a pay by check client
Given i am on the clients page
And i click on add new client button
When i enter clients account name "NewClient TestingTesting"
And i enter the number of employees "30"
...
@addNetPayByCheckTaxExemptClient
