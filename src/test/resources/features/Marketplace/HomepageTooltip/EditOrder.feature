Feature: edit order
clients should be able to edit their orders from the current orders tab. Only marketplace orders that are atleast 48hrs ahead can be edited or customized
...
Scenario: verify the edit order link for my order in tooltip
Given i navigate to "https://staging.tryhungry.com/"
Given i am on the login page
When i enter my email
And i enter my password
...
Scenario: edit order to less than 48hrs
Given i navigate to admin login
When i login with "tahiru@tryhungry.com"
And my password as "tahiru123"
Then i should successfully login to the application
...
Scenario: verify the edit order link for my order is not displayed it is less than 48 hrs
Given i navigate to "https://staging.tryhungry.com/"
Given i am on the login page
When i enter my email
And i enter my password
...
Then i should see that the text in place of edit order link equals "Can’t edit order within 48 hours"
...
When i should see that the tooltip is displayed
When i get the text in place of edit order link
Then i should see that the text in place of edit order link equals "Custom Order - Please contact sales rep. to order again."
