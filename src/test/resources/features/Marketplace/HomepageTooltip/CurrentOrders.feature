@tooltip @tooltipCurrentOrders @marketplaceEnd2End @regression @smoke
Feature: Current orders tab
clients should see their current orders in the current orders tab
...
Scenario: place one order in mk and one order in admin to verify they show up in tooltip
