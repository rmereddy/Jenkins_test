...
@CucumberOptions(features = "src/test/resources/features", glue = { "com/cucumberFramework/stepdefinitions" },tags = {"@sendInvoiceEmailToClient"}, plugin = { "pretty", "html:target/cucumber-reports/cucumber-pretty",
